...
class LalapanDetailPage extends StatelessWidget {
  @override
        ...
        child: Column(
          ...
          children: [
                  ...
                  return Card(
                    ...
                    child: ListTile(
                      ...
                      leading: ClipRRect(
                        ...
                        child: Image.asset(
                          'assets/img/lplp.jpg', // Replace with actual image assets
                          width: 80,
                          height: 80,
                          fit: BoxFit.cover,
                        ),
                      ),
                      title: Text('Lalapan ${index + 1}'),
            ...
            ElevatedButton(
              ...
              child: Text('Tambah Jenis Lalapan'),
